...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v3.3.1"
  WORKING_DIRECTORY "/home/runner/work/neutronium/neutronium/_codeql_build_dir/_deps/cxxopts-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: v3.3.1")
    return()
  endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/neutronium/neutronium/_codeql_build_dir/_deps/cxxopts-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/neutronium/neutronium/_codeql_build_dir/_deps/cxxopts-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
