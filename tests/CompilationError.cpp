...
TEST_F(NeutroniumTester, ImmutableReassignmentFails) {
    ...
    const std::string errorArrayModify = compileFail(codeArrayModify);
    EXPECT_TRUE(
    ...
    const std::string errorArrayReassign = compileFail(codeArrayReassign);
    EXPECT_TRUE(
...
TEST_F(NeutroniumTester, ReassignmentDifferentTypeFails) {
    ...
    const std::string errorIntSizes = compileFail(codeIntSizes);
    ...
    const std::string errorArrayLength = compileFail(codeArrayLength);
    ...
    const std::string errorArrayElementType = compileFail(codeArrayElementType);
    ...
    const std::string errorArrayElementType2 = compileFail(codeArrayElementType2);
    ...
    const std::string errorArrayElementType3 = compileFail(codeArrayElementType3);
...
TEST_F(NeutroniumTester, ConflictingIntegerInferenceFails) {
    ...
    const std::string errorFunctionParam = compileFail(codeFunctionParam);
    ...
    const std::string errorBinaryOp = compileFail(codeBinaryOp);
...
TEST_F(NeutroniumTester, WrongSpecifiedTypeFails) {
    ...
    const std::string errorArrays = compileFail(codeArrays);
...
TEST_F(NeutroniumTester, DifferentElementTypesInArrayFails) {
    ...
    const std::string errorInnerElement = compileFail(codeInnerElement);
    ...
    const std::string errorInnerElementSize = compileFail(codeInnerElementSize);
...
TEST_F(NeutroniumTester, AttemptToSubscriptANonArray) {
    ...
    const std::string error3dArray = compileFail(code3dArray);
...
TEST_F(NeutroniumTester, FunctionArgumentsAreInvalid) {
    ...
    const std::string errorArray = compileFail(codeArray);
